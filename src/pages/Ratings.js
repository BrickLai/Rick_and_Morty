...
import imageIntro from '../picture/66133.jpg';

function Ratings() {
  return (
    <div className='ratingsCharacter'>
     <h2>Rick and Morty Introduction</h2>
     <img src={imageIntro} alt='imageIntro' className='imageIntro' />
      <p>
